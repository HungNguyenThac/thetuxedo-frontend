...
import BannerQuanAu from "../quan/components/banner";
import RenderQuanAu from "../quan/components/renderQuanAu";
QuanAu.propTypes = {};

function QuanAu(props) {
    ...
    async function getData() {
      try {
        ...
        let response = await axios({
          method: "GET",
          url: `http://localhost:1337/products?phanLoai_containss=quanau&${pagination}`,
        });
