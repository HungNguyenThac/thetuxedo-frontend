...
import "./renderComboPhuKien.scss";
...
RenderComboPhuKien.defaultProps = {
  items: [],
  pagination: {},
  onPageChange1: null,
  onPageChange2: null,
...
function RenderComboPhuKien(props) {
...
export default RenderComboPhuKien;
